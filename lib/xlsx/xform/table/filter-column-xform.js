  ...
  parseOpen(node) {
    ...
    switch (node.name) {
      ...
      default:
        ...
        // Ignore unrecognised filter nodes (dynamicFilter, top10, colorFilter,
        // iconFilter, extLst, ...). We don't need them for reading, and render()
        // only writes customFilters back out, so they are not preserved anyway.
        return true;
    }
  }
